...
Four families ship with this site as WOFF2 files in this folder. They are
served from the site's own origin: no request leaves the reader's browser for
a font, no CDN, no tracking. Only the Latin subset is included, which covers
English and Portuguese.

All four are licensed under the **SIL Open Font License 1.1**, which permits
bundling and redistribution with a work like this one. The full licence text
of each family is reproduced below the table.

| Family | Used for | Weights here | Author |
| --- | --- | --- | --- |
| Zilla Slab | Headings | 700 | Mozilla / Typotheque |
| Source Serif 4 | Running text | 400, 400 italic, 600 | Frank Grießhammer, Adobe |
| IBM Plex Sans Condensed | Labels, buttons, small caps | 500, 600, 700 | Mike Abbink, Bold Monday, IBM |
| IBM Plex Mono | Record fields, dice results | 400, 500 | Mike Abbink, Bold Monday, IBM |

Files were taken from the Fontsource distribution of each family.
